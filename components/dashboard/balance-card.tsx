    ...
    <Card className="p-6 bg-white h-full">
      ...
      <div className="space-y-2">
        <div className="flex items-baseline gap-2">
          <span className="text-4xl font-bold">{showBalance ? "450,000.00" : "••••••"}</span>
      ...
      />
       ...
       <SendToCNGNFlow isOpen={showSendToCNGN} onClose={() => setShowSendToCNGN(false)} />
      <SendToBankFlow isOpen={showSendToBank} onClose={() => setShowSendToBank(false)} />
